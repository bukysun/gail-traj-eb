...
def argsparser():
    ...
    parser.add_argument('--adversary_seq_size', help='length of sequence for rnn inputs', type=int, default = None)
    parser.add_argument('--adversary_attn_size', type=int, help = 'size of attention for rnn',default=100)
    parser.add_argument('--adversary_cell_type', type=str, help = 'cell type of rnn', default="lstm")
    parser.add_argument('--adversary_dropout_keep_prob', type=float, default=0.5)
...
def get_task_name(args):
    if args.algo == 'bc':
        ...
        task_name = args.algo + "_gail_traj_eb."
